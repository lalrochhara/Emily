...
import html
import requests
import Emily.modules.sql.chatbot_sql as sql
...
from Emily.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Emily import dispatcher, updater, SUPPORT_CHAT
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(f'https://mizo.otakatsu.studio/mizo/chatbot?message='+Message)
