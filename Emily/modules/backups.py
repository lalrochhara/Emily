...
import Emily.modules.sql.notes_sql as sql
from Emily import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Emily.__main__ import DATA_IMPORT
from Emily.modules.helper_funcs.chat_status import user_admin
from Emily.modules.helper_funcs.alternate import typing_action

# from Emily.modules.rules import get_rules
import Emily.modules.sql.rules_sql as rulessql

# from Emily.modules.sql import warns_sql as warnssql
import Emily.modules.sql.blacklist_sql as blacklistsql
from Emily.modules.sql import disable_sql as disabledsql

# from Emily.modules.sql import cust_filters_sql as filtersql
# import Emily.modules.sql.welcome_sql as welcsql
import Emily.modules.sql.locks_sql as locksql
from Emily.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Emily{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Emily{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Emily-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Emily{}.backup".format(chat_id))  # Cleaning file
