...
from Emily import DEV_USERS, DRAGONS, dispatcher
from Emily.modules.helper_funcs.decorators import Emilycallback
...
def user_admin(permission: AdminPerms):
    def wrapper(func):
        ...
        def awrapper(update: Update, context: CallbackContext, *args, **kwargs):
            ...
            is_anon = bool(update.effective_message.chat_id)
